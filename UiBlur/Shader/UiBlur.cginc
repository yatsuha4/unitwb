...
{
  half4 c = 0;
  c += blur(i, 0.05, -4.0, 0.0);
  c += blur(i, 0.09, -3.0, 0.0);
  c += blur(i, 0.12, -2.0, 0.0);
  c += blur(i, 0.15, -1.0, 0.0);
  c += blur(i, 0.18,  0.0, 0.0);
  c += blur(i, 0.15, +1.0, 0.0);
  c += blur(i, 0.12, +2.0, 0.0);
  c += blur(i, 0.09, +3.0, 0.0);
  c += blur(i, 0.05, +4.0, 0.0);
...
{
  half4 c = 0;
  c += blur(i, 0.05, 0.0, -4.0);
  c += blur(i, 0.09, 0.0, -3.0);
  c += blur(i, 0.12, 0.0, -2.0);
  c += blur(i, 0.15, 0.0, -1.0);
  c += blur(i, 0.18, 0.0,  0.0);
  c += blur(i, 0.15, 0.0, +1.0);
  c += blur(i, 0.12, 0.0, +2.0);
  c += blur(i, 0.09, 0.0, +3.0);
